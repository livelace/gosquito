...
| file_metadata    | -        | bool   | -    | +        | false                     | true                                            | Generate JSON metadata for downloaded file.                                                                |
| file_orig_name   | -        | bool   | -    | +        | true                      | false                                           | Use original file names.                                                                                   |
...
| message_type     | -        | array  | -    | +        | "[]"                      | ["audio", "document"]                           | Process only specific message types (audio, document, photo, text, video, video_note, voice_note).         |
