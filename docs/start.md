...
# AppImage:
user@localhost ~ $ curl -sL "https://github.com/livelace/gosquito/releases/download/v3.0.0/gosquito-v3.0.0.appimage" -o "/tmp/gosquito-v3.0.0.appimage" && chmod +x "/tmp/gosquito-v3.0.0.appimage"
user@localhost ~ $ /tmp/gosquito-v3.0.0.appimage 
