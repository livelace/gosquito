...
```shell
# AppImage:
user@localhost ~ $ curl -sL "https://github.com/livelace/gosquito/releases/download/v3.9.0/gosquito-v3.9.0-e8c28a.appimage" \
  -o "/tmp/gosquito.appimage" && chmod +x "/tmp/gosquito.appimage"
user@localhost ~ $ /tmp/gosquito.appimage 
INFO[30.10.2021 00:27:22.636] gosquito v3.9.0-e8c28a 
...
```shell
user@localhost ~ $ /tmp/gosquito.appimage 
INFO[30.10.2021 00:31:16.468] gosquito v3.9.0-e8c28a 
...
```shell
# Docker:
user@localhost ~ $ docker run -ti --rm ghcr.io/livelace/gosquito:v3.9.0
user@04a308454349 ~ $ gosquito
INFO[29.10.2021 21:34:35.915] gosquito v3.9.0-e8c28a 
