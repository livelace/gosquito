...
```shell
# AppImage:
user@localhost ~ $ curl -sL "https://github.com/livelace/gosquito/releases/download/v4.2.1/gosquito-v4.2.1-95d8db.appimage" \
  -o "/tmp/gosquito.appimage" && chmod +x "/tmp/gosquito.appimage"
user@localhost ~ $ /tmp/gosquito.appimage 
INFO[30.10.2021 00:27:22.636] gosquito v4.2.1-95d8db 
...
```shell
user@localhost ~ $ /tmp/gosquito.appimage 
INFO[30.10.2021 00:31:16.468] gosquito v4.2.1-95d8db 
...
```shell
# Docker:
user@localhost ~ $ docker run -ti --rm ghcr.io/livelace/gosquito:v4.2.1
user@04a308454349 ~ $ gosquito
INFO[29.10.2021 21:34:35.915] gosquito v4.2.1-95d8db 
