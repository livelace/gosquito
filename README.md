...
```shell script
# Docker:
user@localhost /tmp $ docker run -ti --rm livelace/gosquito:v2.1.1 bash
gosquito@fa388e89e10e ~ $ gosquito 
INFO[03.11.2020 14:44:15.806] gosquito v2.1.1   
...
# AppImage:
user@localhost ~ $ curl -sL "https://github.com/livelace/gosquito/releases/download/v2.1.1/gosquito-v2.1.1.appimage" -o "/tmp/gosquito-v2.1.1.appimage" && chmod +x "/tmp/gosquito-v2.1.1.appimage"
user@localhost ~ $ /tmp/gosquito-v2.1.1.appimage 
INFO[04.11.2020 16:59:00.228] gosquito v2.1.1   
