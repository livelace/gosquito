...
```shell script
# Docker:
user@localhost /tmp $ docker run -ti --rm livelace/gosquito:v2.0.0 bash
gosquito@fa388e89e10e ~ $ gosquito 
INFO[03.11.2020 14:44:15.806] gosquito v2.0.0   
...
# AppImage:
user@localhost ~ $ curl -sL "https://github.com/livelace/gosquito/releases/download/v2.0.0/gosquito-v2.0.0.appimage" -o "/tmp/gosquito-v2.0.0.appimage" && chmod +x "/tmp/gosquito-v2.0.0.appimage"
user@localhost ~ $ /tmp/gosquito-v2.0.0.appimage 
INFO[04.11.2020 16:59:00.228] gosquito v2.0.0   
